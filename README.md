...
注：可实现另一个失败拦截器[DeliverThrowableInterceptor](./eventbus-core/src/main/java/com/github/likavn/eventbus/core/api/interceptor/DeliverThrowableInterceptor.java)（每次消息投递都失败发生异常时都会调用该拦截器）
